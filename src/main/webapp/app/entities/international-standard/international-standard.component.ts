...
@Component({
    selector: 'jhi-international-standard',
    templateUrl: './international-standard.component.html'
})
export class InternationalStandardComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/international-standard'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: InternationalStandard) {
        return item.id;
    }
    registerChangeInInternationalStandards() {
        this.eventSubscriber = this.eventManager.subscribe('internationalStandardListModification', (response) => this.loadAll());
    }
    ...
    private onSuccess(data, headers) {
        ...
        this.internationalStandards = data;
    }
