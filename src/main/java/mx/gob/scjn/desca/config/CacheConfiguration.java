...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(mx.gob.scjn.desca.domain.Country.class.getName(), jcacheConfiguration);
            cm.createCache(mx.gob.scjn.desca.domain.Institution.class.getName(), jcacheConfiguration);
