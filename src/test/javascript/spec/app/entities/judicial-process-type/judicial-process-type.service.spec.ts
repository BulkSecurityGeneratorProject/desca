...
describe('Service Tests', () => {
    ...
    describe('JudicialProcessType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(JudicialProcessTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/judicial-process-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return JudicialProcessType', () => {
