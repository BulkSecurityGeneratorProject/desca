...
describe('Service Tests', () => {
    ...
    describe('InternationalStandar Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InternationalStandarService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/international-standars';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InternationalStandar', () => {
