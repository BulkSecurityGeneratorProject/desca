...
describe('Service Tests', () => {
    ...
    describe('InternationalStandard Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InternationalStandardService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/international-standards';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InternationalStandard', () => {
