...
public class VulnerableGroupResourceIntTest {
    ...
    @Autowired
    private VulnerableGroupMapper vulnerableGroupMapper;
    ...
    public void createVulnerableGroup() throws Exception {
        ...
        VulnerableGroupDTO vulnerableGroupDTO = vulnerableGroupMapper.toDto(vulnerableGroup);
        restVulnerableGroupMockMvc.perform(post("/api/vulnerable-groups")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(vulnerableGroupDTO)))
    ...
    public void checkStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = vulnerableGroupRepository.findAll().size();
        // set the field null
        vulnerableGroup.setStatus(null);
    ...
    public void updateVulnerableGroup() throws Exception {
        ...
        VulnerableGroupDTO vulnerableGroupDTO = vulnerableGroupMapper.toDto(updatedVulnerableGroup);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(VulnerableGroupDTO.class);
        VulnerableGroupDTO vulnerableGroupDTO1 = new VulnerableGroupDTO();
        vulnerableGroupDTO1.setId(1L);
        VulnerableGroupDTO vulnerableGroupDTO2 = new VulnerableGroupDTO();
        assertThat(vulnerableGroupDTO1).isNotEqualTo(vulnerableGroupDTO2);
        vulnerableGroupDTO2.setId(vulnerableGroupDTO1.getId());
        assertThat(vulnerableGroupDTO1).isEqualTo(vulnerableGroupDTO2);
        vulnerableGroupDTO2.setId(2L);
        assertThat(vulnerableGroupDTO1).isNotEqualTo(vulnerableGroupDTO2);
        vulnerableGroupDTO1.setId(null);
        assertThat(vulnerableGroupDTO1).isNotEqualTo(vulnerableGroupDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(vulnerableGroupMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(vulnerableGroupMapper.fromId(null)).isNull();
    }
}
